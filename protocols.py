...
def _helper_command(script_name):
    return '{} {} '.format(
        shlex.quote(sys.executable),
        shlex.quote(os.path.join(_HELPER_DIR, script_name)),
    )
...
class ModbusProtocol(Protocol):
    ...
    def __init__(self, protocol):
        ...
        self._client_cmd = _helper_command('synch_client.py')
        ...
        if self._mode == 1:
            ...
            server_cmd_path = _helper_command('servers.py')
